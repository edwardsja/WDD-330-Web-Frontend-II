...
import { makeRequest, userPosts } from './authHelpers.js';
export default class Auth {
  ...
  async getCurrentUser(email) {
    try {
        ...
        let result = makeRequest('users?email=' + email, 'GET', null, this.jwtToken);
        return result;
    } catch (error) {
      // if there were any errors display them
      console.log(error);
